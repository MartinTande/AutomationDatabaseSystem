...
SET @PropulsionHierarchyId = (SELECT Hierarchy1Id FROM HIERARCHY_1 WHERE Hierarchy1Name = 'Propulsion');
...
SET @TanksHierarchyId = (SELECT Hierarchy1Id FROM HIERARCHY_1 WHERE Hierarchy1Name = 'Tanks');
...
SET @UtilitySystemHierarchyId = (SELECT Hierarchy1Id FROM HIERARCHY_1 WHERE Hierarchy1Name = 'Utility Systems');
...
SET @MiscHierarchyId = (SELECT Hierarchy1Id FROM HIERARCHY_1 WHERE Hierarchy1Name = 'Misc');
...
SET @SwitchboardHierarchyId = (SELECT Hierarchy1Id FROM HIERARCHY_1 WHERE Hierarchy1Name = 'Switchboard');
...
SET @HVACHierarchyId = (SELECT Hierarchy1Id FROM HIERARCHY_1 WHERE Hierarchy1Name = 'HVAC');
...
SET @FuelAndLubeOilHierarchyId = (SELECT Hierarchy1Id FROM HIERARCHY_1 WHERE Hierarchy1Name = 'Fuel and Lube Oil');
