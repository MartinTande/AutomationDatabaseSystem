...
UPDATE OBJECT SET
	...
	AcknowledgeAllowedId = (SELECT Id FROM ACKNOWLEDGE_ALLOWED WHERE Name=@AcknowledgeAllowedName),
	AlwaysVisibleId = (SELECT Id FROM ALWAYS_VISIBLE WHERE Name=@AlwaysVisibleName),
