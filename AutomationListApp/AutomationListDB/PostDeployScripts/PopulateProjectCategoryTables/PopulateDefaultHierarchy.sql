...
-- VDU_GROUP
INSERT INTO VDU_GROUP (Name) SELECT 'Bilge' WHERE NOT EXISTS (SELECT 1 FROM VDU_GROUP WHERE Name = 'Bilge');
INSERT INTO VDU_GROUP (Name) SELECT 'Engines' WHERE NOT EXISTS (SELECT 1 FROM VDU_GROUP WHERE Name = 'Engines');
INSERT INTO VDU_GROUP (Name) SELECT 'Cooling' WHERE NOT EXISTS (SELECT 1 FROM VDU_GROUP WHERE Name = 'Cooling');
INSERT INTO VDU_GROUP (Name) SELECT 'Fire System' WHERE NOT EXISTS (SELECT 1 FROM VDU_GROUP WHERE Name = 'Fire System');
INSERT INTO VDU_GROUP (Name) SELECT 'Utility Systems' WHERE NOT EXISTS (SELECT 1 FROM VDU_GROUP WHERE Name = 'Utility Systems');
INSERT INTO VDU_GROUP (Name) SELECT 'System' WHERE NOT EXISTS (SELECT 1 FROM VDU_GROUP WHERE Name = 'System');
INSERT INTO VDU_GROUP (Name) SELECT 'Propulsion' WHERE NOT EXISTS (SELECT 1 FROM VDU_GROUP WHERE Name = 'Propulsion');
INSERT INTO VDU_GROUP (Name) SELECT 'Switchboard' WHERE NOT EXISTS (SELECT 1 FROM VDU_GROUP WHERE Name = 'Switchboard');
INSERT INTO VDU_GROUP (Name) SELECT 'Tanks' WHERE NOT EXISTS (SELECT 1 FROM VDU_GROUP WHERE Name = 'Tanks');
INSERT INTO VDU_GROUP (Name) SELECT 'Misc' WHERE NOT EXISTS (SELECT 1 FROM VDU_GROUP WHERE Name = 'Misc');
INSERT INTO VDU_GROUP (Name) SELECT 'HVAC' WHERE NOT EXISTS (SELECT 1 FROM VDU_GROUP WHERE Name = 'HVAC');
INSERT INTO VDU_GROUP (Name) SELECT 'Fuel and Lube Oil' WHERE NOT EXISTS (SELECT 1 FROM VDU_GROUP WHERE Name = 'Fuel and Lube Oil');
